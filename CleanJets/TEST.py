...
process.source = cms.Source("PoolSource", fileNames = cms.untracked.vstring('file:/afs/cern.ch/user/k/ktos/BoostedDiTau/CMSSW_7_4_1_patch1/src/BoostedTauAnalysis/CleanJets/OUTPUT/CleanJets_edmOuput.root') )
...
# output Definition
####################
process.out = cms.OutputModule("PoolOutputModule", fileName = cms.untracked.string("/afs/cern.ch/user/k/ktos/BoostedDiTau/CMSSW_7_4_1_patch1/src/BoostedTauAnalysis/CleanJets/OUTPUT/CleanJets_edmOuput.root") )
