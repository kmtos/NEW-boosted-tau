...
process.bbaTriggerFilter = cms.EDFilter(
    ...
    outFileName = cms.string("/afs/cern.ch/user/k/ktos/BoostedDiTau/CMSSW_7_4_1_patch1/src/BoostedTauAnalysis/TauAnalyzer/BSUB/DIRNAME/DIRNAME.root"),
...
process.out = cms.OutputModule("PoolOutputModule",
	fileName = cms.untracked.string("file:DIRNAME.root") 
)
