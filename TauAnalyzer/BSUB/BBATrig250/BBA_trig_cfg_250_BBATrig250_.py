...
process.bbaTriggerFilter = cms.EDFilter(
    ...
    outFileName = cms.string("/afs/cern.ch/user/k/ktos/BoostedDiTau/CMSSW_7_4_1_patch1/src/BoostedTauAnalysis/TauAnalyzer/BSUB/BBATrig250/BBATrig250.root"),
...
process.out = cms.OutputModule("PoolOutputModule",
	fileName = cms.untracked.string("file:BBATrig250.root") 
)
