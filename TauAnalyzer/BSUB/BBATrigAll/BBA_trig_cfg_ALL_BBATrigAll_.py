...
mylist = FileUtils.loadListFromFile('/afs/cern.ch/user/k/ktos/BoostedDiTau/CMSSW_7_4_1_patch1/src/BoostedTauAnalysis/TauAnalyzer/FileLists/inFileList_BBA_a30.txt')
...
process.bbaTriggerFilter = cms.EDFilter(
    ...
    outFileName = cms.string("/afs/cern.ch/user/k/ktos/BoostedDiTau/CMSSW_7_4_1_patch1/src/BoostedTauAnalysis/TauAnalyzer/BSUB/BBATrigAll/BBATrigAll.root"),
...
process.out = cms.OutputModule("PoolOutputModule",
	fileName = cms.untracked.string("file:BBATrigAll.root") 
)
